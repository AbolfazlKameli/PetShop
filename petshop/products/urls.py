...
from .apis import categories, products, details, images, reviews
...
categories_paths = [
    ...
    path('<int:category_id>/update/', categories.ProductCategoryUpdateAPI.as_view(), name='category-update'),
    path('<int:category_id>/delete/', categories.ProductCategoryDeleteAPI.as_view(), name='category-delete')
]
...
reviews_paths = [
    ...
    path(
        ...
        reviews.ProductReviewStatusChangeAPI.as_view(),
        name='review-status-change'
    ),
]
...
urlpatterns = [
    ...
    path('<int:product_id>/reviews/', include(reviews_paths)),
]
