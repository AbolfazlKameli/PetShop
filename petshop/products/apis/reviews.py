...
class ProductReviewsListAPI(ListAPIView):
    """
    API for listing all Reviews. Accessible only to admins.
    """
    serializer_class = ProductReviewSerializer
    permission_classes = (IsAdminUser,)
    filterset_fields = ('rate', 'status')
    search_fields = ('body',)
    ...
    def get_queryset(self):
        ...
        return get_reviews_by_product(product)
